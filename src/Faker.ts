...
export default class Faker {
  ...
  get name(): NameGenerator {
    return this.getOrCreateGenerator('name', () => new NameGenerator(this.context));
  }
  ...
  get internet(): InternetGenerator {
    return this.getOrCreateGenerator('internet', () => new InternetGenerator(this.context));
  }
  ...
  get number(): NumberGenerator {
    return this.getOrCreateGenerator('number', () => new NumberGenerator(this.context));
  }
  ...
  get uuid(): UuidGenerator {
    return this.getOrCreateGenerator('uuid', () => new UuidGenerator(this.context));
  }
  ...
  get phone(): PhoneGenerator {
    return this.getOrCreateGenerator('phone', () => new PhoneGenerator(this.context));
  }
  ...
  get address(): AddressGenerator {
    return this.getOrCreateGenerator('address', () => new AddressGenerator(this.context));
  }
  ...
  get company(): CompanyGenerator {
    return this.getOrCreateGenerator('company', () => new CompanyGenerator(this.context));
  }
  ...
  get finance(): FinanceGenerator {
    return this.getOrCreateGenerator('finance', () => new FinanceGenerator(this.context));
  }
  ...
  get dateTime(): DateTimeGenerator {
    return this.getOrCreateGenerator('dateTime', () => new DateTimeGenerator(this.context));
  }
  ...
  get text(): TextGenerator {
    return this.getOrCreateGenerator('text', () => new TextGenerator(this.context));
  }
  ...
  get media(): MediaGenerator {
    return this.getOrCreateGenerator('media', () => new MediaGenerator(this.context));
  }
  ...
  private registerDefaultGenerators(): void {
    ...
    const defaultGenerators = [
      'name', 'internet', 'number', 'uuid', 'phone',
      'address', 'company', 'finance', 'dateTime', 'text', 'media'
    ];
